        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<BlockTemplateEntity>(e =>
            {
                ...
                e.HasData(
                    ...
                    // Replace Jail visiting space with Free Parking neutral space
                    new BlockTemplateEntity { Id = new Guid("00000000-0000-0000-0000-000000000109"), Position = 8, Name = "Estacionamento", Description = "Livre.", ImageUrl = "/images/blocks/property_basic.svg", Color = string.Empty, Price = 0, Rent = 0, Type = BlockType.FreeParking, Level = null, HousePrice = 0, HotelPrice = 0, RentsCsv = null, BoardDefinitionId = boardId },
                    ...
                    new BlockTemplateEntity { Id = new Guid("00000000-0000-0000-0000-000000000115"), Position = 14, Name = "Andaraí", Description = "Andaraí (Mediana)", ImageUrl = "/images/blocks/property_basic.svg", Color = "#27ae60", Price = 2500, Rent = 25, Type = BlockType.Property, Level = PropertyLevel.Mediana, HousePrice = 500, HotelPrice = 700, RentsCsv = "25,125,250,450,550,600,625", BoardDefinitionId = boardId },
