...
public partial class Play : ComponentBase, IAsyncDisposable
{
    ...
    private async Task LoadBoardLayoutAsync(Guid bId)
    {
        ...
        var textPadTop = (int)(cellScaled * 0.15) + 24; // +4 extra top padding
        var textPadBottom = (int)(cellScaled * 0.2);
        // Reduce font size to make Mr. Monopoly's conversation smaller
        var fontSize = Math.Max(10, (int)(cellScaled * 0.16)) + 8; // previously 0.18 + 12
