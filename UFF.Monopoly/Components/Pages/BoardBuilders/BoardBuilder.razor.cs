...
public partial class BoardBuilder : ComponentBase
{
    ...
    internal string GetDefaultImageForType(BlockType t) => t switch { BlockType.Property => "/images/blocks/house1.png", BlockType.Company => "/images/blocks/company1.png", BlockType.GoToJail => "/images/blocks/gotojail.png", BlockType.Tax => "/images/blocks/taxa.png", BlockType.Go => "/images/blocks/inicio.png", BlockType.Chance => "/images/blocks/sorte.png", BlockType.Reves => "/images/blocks/reves.png", BlockType.FreeParking => "/images/board/blocks/parada_livre.png", _ => "/images/blocks/house1.png" };
    ...
    internal static string GetBuildingImage(BuildingType cat, int level) => cat switch { BuildingType.House => $"/images/blocks/house{Math.Clamp(level, 1, 4)}.png", BuildingType.Hotel => $"/images/blocks/hotel{Math.Clamp(level, 1, 4)}.png", BuildingType.Company => $"/images/blocks/company{Math.Clamp(level, 1, 4)}.png", BuildingType.Special => Math.Clamp(level, 1, 4) switch { 1 => "/images/blocks/special_circus.png", 2 => "/images/blocks/special_shopping.png", 3 => "/images/blocks/special_stadium.png", _ => "/images/blocks/special_airport.png" }, _ => "/images/blocks/house1.png" };
